...
/docker-resources/tools/check-integrity.sh 23
...
/docker-resources/tools/check-integrity.sh 28
...
/docker-resources/tools/check-integrity.sh 36
rm /var/www/html
rm -rf /opt/drupal
mkdir /var/www/html
