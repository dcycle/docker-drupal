...
source ./scripts/lib/rebuild-version-multiarch.sh 11 11 linux/amd64,linux/arm64/v8
source ./scripts/lib/rebuild-version-multiarch.sh 11-dev 11-dev linux/amd64,linux/arm64/v8
